...
setup.With_preselected_test_set(data_test, targets_test)\
    ...
    .output_to_file("../results/generalisation/nb/count_postprocessing_single")\
    .output_to_console()\
    .go(data, targets)
...
setup.With_preselected_test_set(data_test, targets_test)\
    ...
    .output_to_file("../results/generalisation/nb/count_postprocessing_stemming")\
    .output_to_console()\
    .go(data, targets)
...
setup.With_preselected_test_set(data_test, targets_test)\
    ...
    .output_to_file("../results/generalisation/nb/count_postprocessing_lemma")\
    .output_to_console()\
    .go(data, targets)
