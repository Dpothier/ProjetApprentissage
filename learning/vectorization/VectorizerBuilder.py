...
class VectorizerConfigurator:
    ...
    def and_stemming(self):
        self.post_tokenizers.append((0, tokens.StemmerPostProcessor()))
        return self

    def and_pos_filter(self):
        self.post_tokenizers.append((3, tokens.POSFilterPostprocessor()))
        return self

    def and_lemmatization(self):
        self.post_tokenizers.append((2, tokens.WordNetLemmatizerPostprocessor()))
        return self
