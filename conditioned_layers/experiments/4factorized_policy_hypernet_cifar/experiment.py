...
def main(gpu):
    ...
    achitecture_params = [(64, 32,4)] #Emb_size, channel_count, factor_count
    seeds = [133]
    epochs = 0
        ...
        for weight_decay in weight_decays:
                for architecture_param in achitecture_params:
                    ...
                    for seed in seeds:
                        ...
                        module = PrimaryNetwork(z_dim=architecture_param[0], filter_size=architecture_param[1], embedding_factor_count=architecture_param[2])
