    ...
    for learning_rate in learning_rates:
        for weight_decay in weight_decays:
            for dropout_rate in dropout_rates:
                ...
                module = policycnn.BuildPolicyCNN(T=T, in_channels=1, state_channels=state_size, seed_size=seed_size, output_size=10)
                ...
                for parameter in parameters:
                    ...
                    if param.requires_grad == False:
                        print ("{} does not require grads".format(name))
                ...
                primitives_at_start = module.stepwiseRNN.update_mem.weight.clone()
                model.fit_generator(mnist_trainset, mnist_devset, epochs=epochs, callbacks=[best_model_restore, csvlogger])

                primitives_at_end = module.stepwiseRNN.update_mem.weight.clone()
