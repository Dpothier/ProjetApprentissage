    ...
    for learning_rate in learning_rates:
        for weight_decay in weight_decays:
            for dropout_rate in dropout_rates:
                ...
                module = policymlp.BuildResidualPolicyMLP(T=T, input_size=784,state_size=state_size, seed_size=state_size, query_size=64, number_of_primitives=state_size, output_size=10)
