...
import networks.policy_cnn.policycnn as policycnn
...
def main(gpu):
    ...
    mnist_trainset = DataLoader(datasets.CIFAR10(root='../datasets', train=True, download=True, transform=transform), batch_size=batch_size)
    mnist_devset = DataLoader(datasets.CIFAR10(root='../datasets', train=False, download=True, transform=transform), batch_size=batch_size)
            ...
            for state_size in state_sizes:
                for seed_size in seeds_sizes:
                    ...
                    for seed in seeds:
                        ...
                        module = policycnn.BuildPolicyCNN(T=T, in_channels=3, state_channels=state_size, seed_size=seed_size, output_size=10)
...
def save_hyperparameters(results, learning_rate, epochs, batch_size, T, state_size, seed_size):
    results.add_result_lines([
