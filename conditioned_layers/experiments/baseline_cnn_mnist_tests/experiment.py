    ...
    for learning_rate in learning_rates:
        for weight_decay in weight_decays:
            for dropout_rate in dropout_rates:
                ...
                module = CNN(state_channels=state_channels, number_of_conv_layers=depth, number_of_classes=10)
                ...
                model.fit_generator(mnist_trainset, mnist_devset, epochs=epochs, callbacks=[gradient_clipping, best_model_restore])
