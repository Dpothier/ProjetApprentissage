            ...
            for T in Ts:
                for state_size in state_sizes:
                    for seed_size in seeds_sizes:
                        output_folder = output_folder_base + "lr_{}_wd_{}_t_{}_state_size_{}/".format(learning_rate, weight_decay, T, state_size[0])
                        results = Results(output_folder)
                        save_hyperparameters(results, learning_rate, weight_decay, epochs, batch_size, T, state_size[0], seed_size)
                        seed_results = {}
                        ...
                        for seed in seeds:
                            ...
                            module = PrimaryNetwork(z_dim=state_size[0], filter_size=state_size[1])
                            ...
                            model.fit_generator(mnist_trainset, mnist_devset, epochs=max_epoch, callbacks=[best_model_restore, csvlogger])
