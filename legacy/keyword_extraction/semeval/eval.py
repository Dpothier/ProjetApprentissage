    ...
    for f in flist_gold:
        ...
        for i, r in enumerate(spans_all):
            ...
            if r in spans_pred:
                ...
                span = r.split(" ")
                super_spans = [span_gold for span_gold in spans_gold if int(span[0]) >= int(span_gold.split(" ")[0]) and int(span[1]) <= int(span_gold.split(" ")[1])]
                # if len(super_spans) != 0:
                #     print("File: {}, Span: {} Super_span: {}".format(f, r, super_spans))
                # else:
                #     print("File: {}, Span: {} is not in pred".format(f, r))
